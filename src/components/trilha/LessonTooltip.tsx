            ...
            <div className="relative bg-[#EE6A29] rounded-[16px] px-4 py-3 shadow-[0_10px_26px_rgba(0,0,0,0.35)] border border-[#F58B4E]">
              ...
              {showSemVidaInfo && (
                <div className="mt-2 rounded-xl border border-[#F6A26C] bg-[#0F212C]/55 p-2.5">
                  ...
                  <p className="text-[11px] text-white/90 mt-1">Como conseguir mais: ir ao PA Teens e ler o QR Code.</p>
                  <p className="text-[11px] text-white/90 mt-1">Regeneração: 1 coração a cada 2h (máximo de 4 corações, total de 8h).</p>
                </div>
              )}
            </div>
